...
GO
INSERT [dbo].[Configuration] ([Id], [Name], [Value], [Environment]) VALUES (9, N'Database.Queue', N'Data Source=localhost;Initial Catalog=NewMomntz.Queue;User Id=momntz;Password=folsom_1;', N'LOCAL')
GO
...
GO
INSERT [dbo].[Configuration] ([Id], [Name], [Value], [Environment]) VALUES (13, N'cloudurl', N'http://qamemorablemoments.blob.core.windows.net', N'PREVIEW')
GO
INSERT [dbo].[Configuration] ([Id], [Name], [Value], [Environment]) VALUES (14, N'cloudaccount', N'qamemorablemoments', N'PREVIEW')
GO
INSERT [dbo].[Configuration] ([Id], [Name], [Value], [Environment]) VALUES (15, N'cloudkey', N'9E1t/udGpskjgHd2Vhy76RoovFenWVORv3noM/Svr2bdC1UkB/iGcdBup46jbwGdk+fLcoa1URtLnkivMDXyEw==', N'PREVIEW')
GO
INSERT [dbo].[Configuration] ([Id], [Name], [Value], [Environment]) VALUES (16, N'cloudurl', N'http://127.0.0.1:10000/devstoreaccount1', N'TEST')
GO
INSERT [dbo].[Configuration] ([Id], [Name], [Value], [Environment]) VALUES (17, N'cloudaccount', N'devstoreaccount1', N'TEST')
GO
INSERT [dbo].[Configuration] ([Id], [Name], [Value], [Environment]) VALUES (18, N'cloudkey', N'Eby8vdM02xNOcqFlqUwJPLlmEtlCDXJ1OUzFT50uSRZ6IFsuFq2UVErCz4I6tq/K1SZFPTOtr/KBHBeksoGMGw==', N'TEST')
GO
INSERT [dbo].[Configuration] ([Id], [Name], [Value], [Environment]) VALUES (19, N'Database.Queue', N'Data Source=localhost;Initial Catalog=NewMomntz.Queue;User Id=momntz;Password=folsom_1;', N'TEST')
GO
INSERT [dbo].[Configuration] ([Id], [Name], [Value], [Environment]) VALUES (20, N'Database.Queue', N'Data Source=192.168.1.109;Initial Catalog=PreviewMomntz.Queue;User Id=momntz;Password=folsom_1;', N'PREVIEW')
GO
